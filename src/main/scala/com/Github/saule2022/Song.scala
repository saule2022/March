...
class Song(title: String = "", author: String= "", lyrics:Seq[String]){
  ...
  def sing(maxLines: Int = -1):Song= {
    ...
    this //so we return a com.github.ValRCS.com.Github.saule2022.Song itself then we can chain the next command
  }
...
class Rap(title:String, author:String, lyrics: Seq[String])
  ...
  //now any com.github.ValRCS.com.Github.saule2022.Rap will have access to ALL com.github.ValRCS.com.Github.saule2022.Song methods and values /fields
