...
//then at some point I can use com.github.ValRCS.RealDog extends com.github.ValRCS.PlatonicDog
...
//at some point I need to create a com.github.ValRCS.RealDog that inherits from abstract class
