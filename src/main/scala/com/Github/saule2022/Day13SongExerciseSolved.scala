...
object Day13SongExerciseSolved extends App {
  ...
  //as long as these methods return com.Github.saule2022.Song object - in this case this very com.Github.saule2022.Song
  ...
  chaotic.sing().yell(2).whisper(1) //this returns com.Github.saule2022.Song so dropIt is not available
