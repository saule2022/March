...
/**
 * Describes a blueprint for a generic com.github.ValRCS.House
 * @param name - com.github.ValRCS.House name
...
//from com.github.ValRCS.Day12Classes defintion
object Day12Classes extends App {
  ...
  val myPlainHouse = new PlainHouse //this creates an object instances out of com.github.ValRCS.PlainHouse blueprint
  println(myPlainHouse)
  val anotherPlainHouse = new PlainHouse //this is a second object out of our com.github.ValRCS.PlainHouse class blueprint
  ...
  //i create another object out of com.github.ValRCS.House class blueprint
